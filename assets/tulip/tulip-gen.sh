...
echo '<circle style="stroke: black; stroke-width: 1; fill: white;" cx="10" cy="18" r="1"/>' >> "$OF"
...
echo '<path style="fill: none; stroke: black;" d="M 8 4 L 10 2 L 12 4" transform="rotate('$(($2 * rotation_multiplier))' 10 10)"></path>' >> "$OF"
...
if [ "$1" = "R" ] || [ "$1" = "r" ]; then
  echo '<circle style="stroke: black; stroke-width: 1; fill: white;" cx="10" cy="10" r="3"/><path style="fill: none; stroke: white;" d="M 10 10 L 13 13"/></svg>' >> "$OF"
elif [ "$1" = "M" ] || [ "$1" = "m" ]; then
  echo '<circle style="stroke: black; stroke-width: 1; fill: white;" cx="10" cy="10" r="1"/></svg>' >> "$OF"
elif [ "$1" = "J" ] || [ "$1" = "j" ]; then
  echo '</svg>' >> "$OF"
elif [ "$1" = "T" ] || [ "$1" = "t" ]; then
